...
def m4a_to_wav(ar):
    ...
    test_dst_folder = '/Users/apple/Desktop/Practicum/self-collect-dataset/test-clean/14/7'
    ...
    for filename in os.listdir(src_folder):
        if filename.endswith('.m4a'):
            ...
            if int(file_index) in [38, 39, 40, 41]:
...
def create_txt_transcriptions():
    ...
    test_folder = '/Users/apple/Desktop/Practicum/self-collect-dataset/test-clean/14/7'
    ...
    with open(input_file, "r", encoding="utf-8") as file:
        ...
        for line_number, line in enumerate(file, start=1):
            ...
            if(line_number <= 37):
                ...
                test_transcriptions.append((f'14_7_{line_number}', line, line, True, 23.61, 25.17, 29.87104))
    ...
    with open(tsv_file, "w", newline="", encoding="utf-8") as file:
        for t in transcriptions:
            ...
            writer.writerow(row.split("\t"))
    # Path to the TSV file
    tsv_file = "/Users/apple/Desktop/Practicum/self-collect-dataset/test-clean/14/7/14_7.trans.tsv"
    # Open the TSV file for writing
    with open(tsv_file, "w", newline="", encoding="utf-8") as file:
        for t in test_transcriptions:
            ...
            row = f"{t[0]}\t{t[1]}\t{t[2]}"
            writer.writerow(row.split("\t"))
    tsv_file = "/Users/apple/Desktop/Practicum/self-collect-dataset/test-clean/14/7/14_7.book.tsv"
    # Open the TSV file for writing
    with open(tsv_file, "w", newline="", encoding="utf-8") as file:
        for t in test_transcriptions:
            writer = csv.writer(file, delimiter='\t', quoting=csv.QUOTE_MINIMAL)
